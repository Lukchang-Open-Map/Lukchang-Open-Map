-- First, delete the point-based entries (they're not zones, they're posts)
DELETE FROM public.security_zones WHERE ST_GeometryType(geometry) = 'ST_Point';

-- Now insert a proper POLYGON security zone covering the Lukchang campus
